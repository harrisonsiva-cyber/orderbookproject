...
def main():
    ...
    subparsers = parser.add_subparsers(dest="command")  # dest="command"-subcommand name will be stored in args.command

    greet_parser = subparsers.add_parser("greet", help="Greet a user")  # Adding 'greet' subcommand to the subparsers
